...
const HeaderDashboard = () => {
  return (
    <HeaderDashboardStyled id="masthead">
      <Container>
        <Row>
          <Col md={8}>
            <h1>Dasbor</h1>
            <h2 className="leading">
              Selamat datang di dasbor! Disinilah Anda dapat melihat informasi tentang permintaan, riwayat, dan melihat tagihan sewa mobil Anda.
            </h2>
            ...
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>Dasbor</Breadcrumb.Item>
            </Breadcrumb>
          </Col>
        </Row>
      </Container>
