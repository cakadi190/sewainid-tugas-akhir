...
export default function CreateData({
  ...
  const {
    ...
    Omit<Database["CarRepairNoteData"], "id" | "created_at" | "updated_at"> & {
      gallery: File[];
    }
  >({
  ...
  const fetchCarOptions = () => {
    ...
    axios
      .get(route("v1.admin.options.car-data"))
      .then((response) => {
  ...
  return (
    <div className="my-auto">
      <Button className="gap-2 align-items-center d-flex" onClick={onOpen}>
        ...
        <span className="d-none d-md-none d-lg-inline-flex">
              ...
              <div className="mb-3 form-group">
                <Form.Floating>
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setData("car_data_id", parseInt(e.target.value) || 0)
                    }
              ...
              <div className="mb-3 form-group">
                <Form.Floating>
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setData("last_mileage", parseInt(e.target.value) || 0)
                    }
              ...
              <div className="mb-3 form-group">
                <Form.Floating>
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setData("current_mileage", parseInt(e.target.value) || 0)
                    }
                ...
                <Form.Floating>
                  <Form.Select
                    ...
                    onChange={(e) =>
                      setData(
                        "status",
                        e.target.value as CarRepairNoteStatusEnum
                      )
                    }
                    ...
                    {Object.values(CarRepairNoteStatusEnum).map((status) => (
                      <option key={status} value={status}>
                        {getCarRepairStatusLabel(
                          status as CarRepairNoteStatusEnum
                        )}
                      </option>
                    ))}
                  </Form.Select>
