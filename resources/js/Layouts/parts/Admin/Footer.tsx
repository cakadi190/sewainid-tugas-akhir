...
const Footer: React.FC = () => {
  return (
    <footer className="mt-auto text-center border-top text-lg-start">
      <Container fluid className="py-3">
        <Row>
          <Col lg={6} className="text-muted">
            &copy; {new Date().getFullYear()} <Link href="/">Sewain.id</Link> oleh <a href="https://www.kokodingin.id">Kodinus</a>. Semua hak dilindungi.
          </Col>
