...
interface CrudHelper
{
     ...
     */
    public function createData(mixed $request, Model $model, array|null $singleUploadTarget = [], array|null $multipleUploadTarget = [], ?callable $beforeCreating = null, ?callable $afterCreating = null): RedirectResponse;
     ...
     * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException If file upload fails.
     */
    public function editData(mixed $request, Model $model, array|null $singleUploadTarget = [], array|null $multipleUploadTarget = [], ?callable $beforeCreating = null, ?callable $afterCreating = null): RedirectResponse;
